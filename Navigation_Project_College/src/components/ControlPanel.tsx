...
const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <div className={`bg-white p-6 overflow-y-auto ${className}`}>
      {/* Header */}
      <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-800">Campus AI Navigator</h1>
          <p className="text-sm text-gray-600">Voice-powered navigation assistant</p>
        </div>
      </div>
